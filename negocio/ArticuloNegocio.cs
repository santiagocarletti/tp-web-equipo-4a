    ...
    public class ArticuloNegocio
    {
        ...
        public List<Articulo> listar()
        {
            ...
            try
            {
                ...
                while (datos.Lectorbd.Read())
                {
                    ...
                    //para no cargar duplicado, si sólo se agrega imagen
        ...
        public void agregar(Articulo newArticulo)
        {
            ...
            try
            {
                ...
                //ejecutarAccionConReturn da el id de la BD, usado para agregar imágenes agregándolo a la consulta

                newArticulo.Id = datos.ejecutarAccionconreturn();

                datos.limpiarParametros();
                
                //No se borran imágenes como en modificar, por que el id no tiene ninguna.
                //Por cada imagen cargada en la lista, inserta a la BD en la tabla de imágenes
        ...
        public void modificar(Articulo articulo)
        {
            ...
            try
            {
                //Si es null la marca o la categoría, (fue borrada), entonces no manda a la BD
